...
; SHADERTEST: call <4 x i32> @llpc.call.desc.load.buffer.v4i32.i32.i32.i32.i1(i32 0, i32 1, i32 0, i1 false)
; SHADERTEST: call <16 x i8> @llpc.buffer.load.v16i8(<4 x i32> %{{[0-9]*}}, i32 0, i1 true, i32 0, i1 false)
; SHADERTEST: call <4 x i32> @llpc.call.desc.load.buffer.v4i32.i32.i32.i32.i1(i32 0, i32 0, i32 0, i1 false)
; SHADERTEST: call <4 x i8> @llpc.buffer.load.v4i8(<4 x i32> %{{[0-9]*}}, i32 0, i1 true, i32 0, i1 false)
; SHADERTEST: call <4 x i32> @llpc.call.desc.load.buffer.v4i32.i32.i32.i32.i1(i32 0, i32 1, i32 1, i1 false)
...
; SHADERTEST: call <4 x i32> @llpc.call.desc.load.buffer.v4i32.i32.i32.i32.i1(i32 0, i32 1, i32 %{{[0-9]*}}, i1 false)
